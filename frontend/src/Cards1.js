...
const Cards1 = () => {
    ...
    const shuffledProducts = shuffleArray(productdata).filter(product => product.productbrand === "Earbuds");
    ...
    return (
        <div style={{ backgroundColor: "#EDFEFE" }}>
            <Tws />
            <div className='container-fluid' style={{ textTransform: "capitalize", backgroundColor: "#F1FFFF" }}>
                                ...
                                <Card.Body style={{ backgroundColor: "#FAFAFA", borderRadius: "14px" }}>
                                    ...
                                    <div className='d-flex justify-content-start'>
                                        <span style={{ fontSize: "18px", color: "black" }}>
                                            <strong><LiaRupeeSignSolid />{product.productprice}</strong>
                                        </span>
                                        <span className='p-1' style={{ fontSize: "15px", textDecoration: "line-through" }}>
                                            <LiaRupeeSignSolid />{product.productdis}
                                        </span>
                                        <span className='py-1' style={{ fontSize: "15px", color: "#0E946A" }}>
                                            {product.productoff} off
                                        </span>
                                    </div>
                                    <button
                                        style={{ width: "100%", height: "40px", backgroundColor: "black", color: "white", borderRadius: "10px", marginTop: "10px" }}
