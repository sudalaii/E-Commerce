...
const CardWatch = () => {
    ...
    const shuffledProducts = shuffleArray(productdata).filter(product => product.productbrand === "watch");
                        ...
                        <div key={index} className=' col-lg-3 col-sm-12 col-md-6 mb-3'>
                            <Card className="animi" style={{ borderRadius: "16px" }}>
                                ...
                                <Card.Body style={{ backgroundColor: "#FAFAFA", borderRadius: "14px" }}>
                                    ...
                                    <button onClick={() => {
                                        addToCart(product)
                                    }} style={{ width: "100%", height: "40px", backgroundColor: "black", color: "white", borderRadius: "10px", marginTop: "10px" }}>Add to cart</button>
